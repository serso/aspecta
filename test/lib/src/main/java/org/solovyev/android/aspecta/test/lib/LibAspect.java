...
public class LibAspect {
    ...
    @Pointcut("execution(@org.solovyev.android.aspecta.test.lib.LibAnnotation * *(..))")
    public void method() {
    }

    @Pointcut("execution(@org.solovyev.android.aspecta.test.lib.LibAnnotation *.new(..))")
